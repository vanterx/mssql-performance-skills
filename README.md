...
```bash
cp -rfi skills/*       ~/.claude/skills/
cp -rfi skills/tsql-review       ~/.claude/skills/tsql-review
cp -rfi skills/sqlstats-review   ~/.claude/skills/sqlstats-review
cp -rfi skills/sqltrace-review   ~/.claude/skills/sqltrace-review
cp -rfi skills/sqlwait-review    ~/.claude/skills/sqlwait-review
cp -rfi skills/sqlplan-review    ~/.claude/skills/sqlplan-review
cp -rfi skills/sqlplan-batch     ~/.claude/skills/sqlplan-batch
