...
| [sqlblocking-review](#sqlblocking-review) | Analyze a live blocking chain — 36 checks (BL1–BL36): head blocker identification and state, chain topology, lock escalation and Sch-M evidence, transaction/isolation faults, blocked process report readiness |
...
║  36 checks — head blocker and whether it self-resolves,      ║
║  chain depth/fan-out, escalation, Sch-M, isolation, BPR      ║
║                                                              ║
...
Analyze a live SQL Server blocking chain: find the head blocker, decide whether the block will clear on its own, read the lock evidence, and name the transaction or isolation design fault behind it. 36 checks (BL1–BL36).
...
| BL1–BL36 | 36 | sqlblocking-review | Blocking chain: head blocker identification and state classification, chain topology, lock escalation/Sch-M/key-range evidence, transaction and isolation design, blocked process report readiness |
