...
| [sqlag-review](#sqlag-review) | Audit Always On AG configuration correctness across all layers — 36 checks (F1–F36): prerequisites, replica design, listener architecture, backup strategy, endpoint security, distributed AG topology, Basic/Contained AG constraints, AG scale ceiling |
...
║         ▼                                                    ║
║  /sqlag-review                                               ║
║  36 checks — prerequisites, replica design, listener,        ║
...
Audits Always On Availability Group configuration correctness across all layers — prerequisites, replica design, listener architecture, backup strategy, endpoint security, distributed AG topology, and Basic/Contained AG constraints. Applies 36 checks (F1–F36) across seven categories. Companion to `/sqlhadr-review` (runtime health) and `/sqlclusterlog-review` (WSFC events).
...
| F1–F36 | 36 | sqlag-review | AG configuration correctness: prerequisites, replica design, listener, backup, endpoint security, distributed AG, advanced features, scale ceiling |
