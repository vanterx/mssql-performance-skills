...
| [sqlencryption-review](#sqlencryption-review) | Analyze the full SQL Server encryption posture from DMV output — 56 checks (A1–A56): TDE coverage, certificate expiry/rotation, Always Encrypted column gaps, backup encryption, transport/TLS, CLE key algorithms, DMK/SMK key hierarchy, EKM/AKV, sensitivity-label coverage, FIPS/PCI-DSS/HIPAA/GDPR compliance |
...
Analyzes the complete SQL Server encryption posture by reviewing output from 17 DMVs covering all encryption layers. Applies 56 checks (A1–A56) across 10 categories: TDE, Always Encrypted, Cell-Level Encryption, Backup Encryption, Transport/TLS, Certificate Management, Key Management, Key Hierarchy, EKM/AKV, and Compliance.

**Triggers:** `/sqlencryption-review`, `/encryption-review`, `/tde-review`, `/always-encrypted-review`, `/backup-encryption-review`
...
| A1–A56 | 56 | sqlencryption-review | TDE, Always Encrypted, CLE, backup, transport, certs, keys, EKM, compliance |
