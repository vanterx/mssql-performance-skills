...
| [tsql-review](#tsql-review) | Analyze raw T-SQL source code — 78 checks (T1–T78) — structural, security, correctness, performance |
...
|-------|-------|-------|----------|
| T1–T78 | 78 | tsql-review | T-SQL static analysis |
