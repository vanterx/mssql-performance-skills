...
| [skills/sqlhadr-review/SKILL.md](skills/sqlhadr-review/SKILL.md) | Always On AG health analysis: `sqlhadr-review`. 28 checks (H1–H28) — replica connectivity, data loss risk, recovery time, throughput, configuration, and seeding/initialization integrity |
