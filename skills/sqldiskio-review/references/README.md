# sqldiskio-review — Reference Index
...
- The full Quick Reference table for all 15 checks at a glance
...
fix options, or DMV output examples. Also when the user asks "explain check ZX"
or "what does this finding mean?"

**What it covers:** The full five-part explanation (What it means / How to
spot it / Example / Fix options / Related checks) for all 15 checks plus the
