# query-store-review — Checks Explained
...
- [IQP, PSP, and Feedback Checks (Q26–Q30)](#iqp-psp-and-feedback-checks-q26q30)
...
Use `/query-store-review` when you have Query Store DMV output and want to:
...
2. Run `/sqlplan-index-advisor` on the current plan to get exact CREATE INDEX DDL
3. Run `/sqlplan-compare` if you have both plans

**Related checks:** Q1, Q15, C1 (sqlplan-compare), N4 (sqlplan-review), D2 (sqlplan-index-advisor)
...
```
**Fix options:**
1. Run `/sqlplan-index-advisor` on the plan — generating covering indexes is the highest-leverage fix
...
**Related checks:** Q3, I1, I5 (sqlstats-review), N5 (sqlplan-review), D1 (sqlplan-index-advisor)
...
3. BUFFER_IO dominant: reduce logical reads via indexing → `/sqlplan-index-advisor`
...
**Related checks:** Q19, P2 (sqlplan-deadlock), V2 (sqlwait-review)
...
## IQP, PSP, and Feedback Checks (Q26–Q30)
...
**Related checks:** Q23 (QS near size limit), H26 (hadr-health-review RCSI)
