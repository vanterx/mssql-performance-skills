...
- **Fix:** Add a clustered index to convert the heap to a B-tree table. Row-level key locks replace RID locks, reducing deadlock surface. Use `/sqlplan-index-advisor` to identify the best clustering key.
