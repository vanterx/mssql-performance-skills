...
> **Input:** `skills/sqlprocstats-review/examples/proc_stats_trend.txt` — Q5 (Trend / Time Series)
> Run with: `/sqlprocstats-review skills/sqlprocstats-review/examples/proc_stats_trend.txt`
...
| 4 — Today | Run `/sqlindex-advisor` on captured plan | W2 | 30 min |
